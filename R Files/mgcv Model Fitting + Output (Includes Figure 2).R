...
plot(presence_model, select = 4, shade = TRUE,  se = 1.96, ylim = c(-2.2,1.2), rug = T, 
     main = "***", cex.main = 2.5,
     shade.col = "light blue", xlab = "Btm. Temperature Range", 
     ylab = "Partial Effect", cex.lab = 1.9, cex.axis = 1.9)
plot(presence_model, select = 5, shade = TRUE,  se = 1.96, ylim = c(-2.2,1.2), rug = T, 
     main = "***", cex.main = 2.5,
...
survey_data_combined["residuals_presence"] <- simulateResiduals(fittedModel = presence_model, 
...
survey_data_combined_CPUE["residuals_CPUE"] <- simulateResiduals(fittedModel = CPUE_model, 
                                                                 plot = T)$scaledResiduals
